...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "otg"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '12NYixWhe9ZKHVpf', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/otg.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{B40BBF3D-F2D9-4EB0-BEDB-E582E946496C}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "otg"]
	],
