 ...
 * Page class
 */
class kontak_customer_delete extends kontak_customer
{
	...
	// Page object name
	public $PageObjName = "kontak_customer_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("kontak_customerlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("kontak_customerlist.php"); // Return to list
			}
		}
	}
