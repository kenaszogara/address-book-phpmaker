...
/**
 * Table class for kontak_bisnis
 */
class kontak_bisnis extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'kontak_bisnis';
		$this->TableName = 'kontak_bisnis';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`kontak_bisnis`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// id_kontak
		$this->id_kontak = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_id_kontak', 'id_kontak', '`id_kontak`', '`id_kontak`', 3, 11, -1, FALSE, '`id_kontak`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_nuskin
		$this->id_nuskin = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_id_nuskin', 'id_nuskin', '`id_nuskin`', '`id_nuskin`', 200, 255, -1, FALSE, '`id_nuskin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id_nuskin->Sortable = TRUE; // Allow sort
		$this->fields['id_nuskin'] = &$this->id_nuskin;

		// nama
		$this->nama = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// no_hp
		$this->no_hp = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_no_hp', 'no_hp', '`no_hp`', '`no_hp`', 200, 255, -1, FALSE, '`no_hp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_hp->Sortable = TRUE; // Allow sort
		$this->fields['no_hp'] = &$this->no_hp;

		// email
		$this->_email = new DbField('kontak_bisnis', 'kontak_bisnis', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// gender
		$this->gender = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_gender', 'gender', '`gender`', '`gender`', 200, 255, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->gender->Lookup = new Lookup('gender', 'kontak_bisnis', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->gender->OptionCount = 2;
		$this->fields['gender'] = &$this->gender;

		// tgl_lahir
		$this->tgl_lahir = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_tgl_lahir', 'tgl_lahir', '`tgl_lahir`', CastDateFieldForLike("`tgl_lahir`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_kenal
		$this->tgl_kenal = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_tgl_kenal', 'tgl_kenal', '`tgl_kenal`', CastDateFieldForLike("`tgl_kenal`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_kenal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// created_at
		$this->created_at = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->Sortable = FALSE; // Allow sort
		$this->created_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['created_at'] = &$this->created_at;

		// created_by
		$this->created_by = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, 11, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_by->Sortable = FALSE; // Allow sort
		$this->created_by->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['created_by'] = &$this->created_by;

		// updated_at
		$this->updated_at = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->updated_at->Sortable = FALSE; // Allow sort
		$this->updated_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['updated_at'] = &$this->updated_at;

		// updated_by
		$this->updated_by = new DbField('kontak_bisnis', 'kontak_bisnis', 'x_updated_by', 'updated_by', '`updated_by`', '`updated_by`', 3, 11, -1, FALSE, '`updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`kontak_bisnis`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "kontak_bisnisedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "kontak_bisnisadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("kontak_bisnisview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("kontak_bisnisview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "kontak_bisnisadd.php?" . $this->getUrlParm($parm);
		else
			$url = "kontak_bisnisadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("kontak_bisnisedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("kontak_bisnisadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("kontak_bisnisdelete.php", $this->getUrlParm());
	}
