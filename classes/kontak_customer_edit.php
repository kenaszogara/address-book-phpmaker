 ...
 * Page class
 */
class kontak_customer_edit extends kontak_customer
{
	...
	// Page object name
	public $PageObjName = "kontak_customer_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("kontak_customerlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "kontak_customerlist.php")
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// id_kontak
			$this->id_kontak->setDbValueDef($rsnew, $this->id_kontak->CurrentValue, NULL, $this->id_kontak->ReadOnly);

			// id_nuskin
			$this->id_nuskin->setDbValueDef($rsnew, $this->id_nuskin->CurrentValue, NULL, $this->id_nuskin->ReadOnly);
			...
			// tgl_kenal
			$this->tgl_kenal->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_kenal->CurrentValue, 0), NULL, $this->tgl_kenal->ReadOnly);
