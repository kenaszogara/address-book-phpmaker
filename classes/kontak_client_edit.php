 ...
 * Page class
 */
class kontak_client_edit extends kontak_client
{
	...
	// Page object name
	public $PageObjName = "kontak_client_edit";
	...
	public function run()
	{
		...
		if (!$this->setupApiRequest()) {
			...
			if (!$Security->canEdit()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("kontak_clientlist.php"));
				else
		...
		if (!$Security->canEdit()) {
			...
			$this->terminate("kontak_clientlist.php");
			return;
		}
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("kontak_clientlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "kontak_clientlist.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("kontak_clientlist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
