...
class index
{
	...
	public function run()
	{
		...
		if (!$Security->isLoggedIn())
			$Security->autoLogin();
		if ($Security->allowList(CurrentProjectID() . 'kontak'))
			$this->terminate("kontaklist.php"); // Exit and go to default page
		...
		if ($Security->allowList(CurrentProjectID() . 'kontak_bisnis'))
			$this->terminate("kontak_bisnislist.php");
		if ($Security->allowList(CurrentProjectID() . 'kontak_customer'))
