 ...
 * Page class
 */
class kontak_delete extends kontak
{
	...
	// Page object name
	public $PageObjName = "kontak_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("kontaklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("kontaklist.php"); // Return to list
			}
		}
	}
