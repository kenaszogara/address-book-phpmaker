...
/**
 * Table class for kontak_customer
 */
class kontak_customer extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'kontak_customer';
		$this->TableName = 'kontak_customer';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`kontak_customer`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('kontak_customer', 'kontak_customer', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// id_kontak
		$this->id_kontak = new DbField('kontak_customer', 'kontak_customer', 'x_id_kontak', 'id_kontak', '`id_kontak`', '`id_kontak`', 3, 11, -1, FALSE, '`id_kontak`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_kontak->Lookup = new Lookup('id_kontak', 'kontak', FALSE, 'id', ["nama","","",""], [], [], [], [], ["id_nuskin","nama","no_hp","email","gender","tgl_lahir","tgl_kenal"], ["x_id_nuskin","x_nama","x_no_hp","x__email","x_gender","x_tgl_lahir","x_tgl_kenal"], '', '');
		$this->id_kontak->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['id_kontak'] = &$this->id_kontak;

		// id_nuskin
		$this->id_nuskin = new DbField('kontak_customer', 'kontak_customer', 'x_id_nuskin', 'id_nuskin', '`id_nuskin`', '`id_nuskin`', 200, 255, -1, FALSE, '`id_nuskin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id_nuskin->Sortable = TRUE; // Allow sort
		$this->fields['id_nuskin'] = &$this->id_nuskin;

		// nama
		$this->nama = new DbField('kontak_customer', 'kontak_customer', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// no_hp
		$this->no_hp = new DbField('kontak_customer', 'kontak_customer', 'x_no_hp', 'no_hp', '`no_hp`', '`no_hp`', 200, 255, -1, FALSE, '`no_hp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_hp->Sortable = TRUE; // Allow sort
		$this->fields['no_hp'] = &$this->no_hp;

		// email
		$this->_email = new DbField('kontak_customer', 'kontak_customer', 'x__email', 'email', '`email`', '`email`', 200, 255, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// gender
		$this->gender = new DbField('kontak_customer', 'kontak_customer', 'x_gender', 'gender', '`gender`', '`gender`', 200, 255, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->gender->Lookup = new Lookup('gender', 'kontak_customer', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->gender->OptionCount = 2;
		$this->fields['gender'] = &$this->gender;

		// tgl_lahir
		$this->tgl_lahir = new DbField('kontak_customer', 'kontak_customer', 'x_tgl_lahir', 'tgl_lahir', '`tgl_lahir`', CastDateFieldForLike("`tgl_lahir`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_lahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_kenal
		$this->tgl_kenal = new DbField('kontak_customer', 'kontak_customer', 'x_tgl_kenal', 'tgl_kenal', '`tgl_kenal`', CastDateFieldForLike("`tgl_kenal`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_kenal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// created_at
		$this->created_at = new DbField('kontak_customer', 'kontak_customer', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->Sortable = FALSE; // Allow sort
		$this->created_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['created_at'] = &$this->created_at;

		// created_by
		$this->created_by = new DbField('kontak_customer', 'kontak_customer', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, 11, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_by->Sortable = FALSE; // Allow sort
		$this->created_by->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['created_by'] = &$this->created_by;

		// updated_at
		$this->updated_at = new DbField('kontak_customer', 'kontak_customer', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->updated_at->Sortable = FALSE; // Allow sort
		$this->updated_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['updated_at'] = &$this->updated_at;

		// updated_by
		$this->updated_by = new DbField('kontak_customer', 'kontak_customer', 'x_updated_by', 'updated_by', '`updated_by`', '`updated_by`', 3, 11, -1, FALSE, '`updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`kontak_customer`";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->id_nuskin->DbValue = $row['id_nuskin'];
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "kontak_customerlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "kontak_customerview.php")
			return $Language->phrase("View");
		elseif ($pageName == "kontak_customeredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "kontak_customeradd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("kontak_customerview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("kontak_customerview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "kontak_customeradd.php?" . $this->getUrlParm($parm);
		else
			$url = "kontak_customeradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("kontak_customeredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("kontak_customeradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("kontak_customerdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->id_nuskin->setDbValue($rs->fields('id_nuskin'));
	...
	public function renderListRow()
	{
		...
		$this->updated_by->ViewValue = FormatNumber($this->updated_by->ViewValue, 0, -2, -2, -2);
	...
	public function renderEditRow()
	{
		...
		$this->id_nuskin->EditValue = $this->id_nuskin->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->id_nuskin);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->id_nuskin);
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$rsnew['created_at'] = CurrentDateTime();
	...
	function Row_Updating($rsold, &$rsnew) {
		...
		$rsnew['updated_at'] = CurrentDateTime();
