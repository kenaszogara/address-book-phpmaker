 ...
 * Page class
 */
class kontak_client_view extends kontak_client
{
	...
	// Page object name
	public $PageObjName = "kontak_client_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "kontak_clientlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "kontak_clientlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "kontak_clientlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
