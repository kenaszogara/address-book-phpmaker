...
class jurnal extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('jurnal', 'jurnal', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// id_kontak
		$this->id_kontak = new DbField('jurnal', 'jurnal', 'x_id_kontak', 'id_kontak', '`id_kontak`', '`id_kontak`', 3, 11, -1, FALSE, '`id_kontak`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_kontak->Lookup = new Lookup('id_kontak', 'kontak', FALSE, 'id', ["nama","","",""], [], [], [], [], [], [], '', '');
		$this->id_kontak->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['id_kontak'] = &$this->id_kontak;

		// item
		$this->item = new DbField('jurnal', 'jurnal', 'x_item', 'item', '`item`', '`item`', 200, 50, -1, FALSE, '`item`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->item->Sortable = TRUE; // Allow sort
		$this->fields['item'] = &$this->item;

		// qty
		$this->qty = new DbField('jurnal', 'jurnal', 'x_qty', 'qty', '`qty`', '`qty`', 3, 11, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// memo
		$this->memo = new DbField('jurnal', 'jurnal', 'x_memo', 'memo', '`memo`', '`memo`', 200, 255, -1, FALSE, '`memo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->memo->Sortable = TRUE; // Allow sort
		$this->fields['memo'] = &$this->memo;

		// tgl
		$this->tgl = new DbField('jurnal', 'jurnal', 'x_tgl', 'tgl', '`tgl`', CastDateFieldForLike("`tgl`", 0, "DB"), 133, 10, 0, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// created_at
		$this->created_at = new DbField('jurnal', 'jurnal', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->Sortable = FALSE; // Allow sort
		$this->created_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['created_at'] = &$this->created_at;

		// created_by
		$this->created_by = new DbField('jurnal', 'jurnal', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 3, 11, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_by->Sortable = FALSE; // Allow sort
		$this->created_by->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['created_by'] = &$this->created_by;

		// updated_at
		$this->updated_at = new DbField('jurnal', 'jurnal', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->updated_at->Sortable = FALSE; // Allow sort
		$this->updated_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['updated_at'] = &$this->updated_at;

		// updated_by
		$this->updated_by = new DbField('jurnal', 'jurnal', 'x_updated_by', 'updated_by', '`updated_by`', '`updated_by`', 3, 11, -1, FALSE, '`updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function renderEditRow()
	{
		...
		if (!$this->memo->Raw)
			$this->memo->CurrentValue = HtmlDecode($this->memo->CurrentValue);
