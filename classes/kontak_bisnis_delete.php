 ...
 * Page class
 */
class kontak_bisnis_delete extends kontak_bisnis
{
	...
	// Page object name
	public $PageObjName = "kontak_bisnis_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("kontak_bisnislist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("kontak_bisnislist.php"); // Return to list
			}
		}
	}
