 ...
 * Page class
 */
class kontak_client_delete extends kontak_client
{
	...
	// Page object name
	public $PageObjName = "kontak_client_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("kontak_clientlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("kontak_clientlist.php"); // Return to list
			}
		}
	}
