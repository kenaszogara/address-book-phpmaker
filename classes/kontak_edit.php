 ...
 * Page class
 */
class kontak_edit extends kontak
{
	...
	// Page object name
	public $PageObjName = "kontak_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("kontaklist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "kontaklist.php")
